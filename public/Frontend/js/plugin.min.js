...
!function (a, b, c) {
    a.fn.scrollUp = function (b) {
        ...
        e.scrollImg || f.html(e.scrollText), f.css({
            ...
            position: "fixed",
            zIndex: e.zIndex
        }), e.activeOverlay && a("<div/>", {id: e.scrollName + "-active"}).css({
            position: "absolute",
...
!function (e, t) {
    ...
    var ae = ne.document, re = ae.getElementsByTagName("html")[0], ie = 0, se = "nav-open", i = function (e, t) {
        ...
        var ee = [], te = function (e) {
            ...
            if (e.querySelector("ul") || "UL" === e.tagName) {
                var E = "hc-nav-" + ++ie, l = R.printStyle("hc-offcanvas-" + ie + "-style"),
                    s = "keydown.hcOffcanvasNav", c = R.createElement("nav", {role: "navigation"}),
                    v = R.createElement("div", {class: "nav-container"});
                c.addEventListener("click", R.stopPropagation), c.appendChild(v);
                var n, u, a, d = null, p = null, r = {}, f = !1, h = !1, m = null, y = 0, b = 0, g = 0, L = null,
                    A = {}, x = [], C = !1, k = [], o = null, O = null, N = !1, T = !1;
                ...
                var w = function (e, t, n) {
                    ...
                    var e = R.formatSizeVal(b = v.offsetWidth), t = R.formatSizeVal(g = v.offsetHeight);
                    ...
                    var t = ne.getComputedStyle(d).display,
                        n = !!Z.disableAt && "max-width: " + (Z.disableAt - 1) + "px", a = R.formatSizeVal(Z.width),
                        r = R.formatSizeVal(Z.height), i = R.formatSizeVal(Z.levelSpacing);
                    ...
                    !function m(e, t, y, b, n, a) {
                        ...
                        g.appendChild(r);
                        t.appendChild(g);
                        b && r.insertBefore(R.createElement("h2", {class: 0 === y ? "nav-title" : "Neputertech"}, b), r.firstChild);
                        e.forEach(function (e, t) {
                            ...
                            r.appendChild(h), Z.keepClasses && e.classes && h.classList.add.apply(h.classList, e.classes.split(" ")), 0 === t && b && h.setAttribute("aria-label", b), e.id && h.setAttribute("aria-labelledby", "menu-" + e.id), e.items.forEach(function (e, t) {
                                var n = e.content;
                                if (e.custom) {
                                    var a = R.createElement("li", {class: "custom-content"}, R.createElement("div", {class: "nav-item nav-item-custom"}, Array.prototype.map.call(n, function (e) {
                                ...
                                i ? (r = R.clone(i, !1, !0)).classList.add("nav-item") : r = R.createElement(e.subnav.length ? "a" : "span", {class: "nav-item"}, Array.prototype.map.call(n, function (e) {
                                    return R.clone(e, !0, !0)
                                ...
                                if (e.subnav.length) {
                                    ...
                                    if (A[l] || (A[l] = 0), s.classList.add("nav-parent"), W()) {
                                        var u = A[l], d = R.createElement("input", {
                                            type: "checkbox",
                                            id: E + "-" + l + "-" + u,
                                            class: "hc-chk",
                                            tabindex: -1,
                        ...
                        if (y && void 0 !== n && !1 !== Z.insertBack && "overlap" === Z.levelOpen) {
                            var i = R.children(r, "ul"), s = Z.levelTitleAsBack && a || Z.labelBack || "",
                                o = R.createElement("a", {
                                    href: "#",
                                    role: "menuitem",
                                    tabindex: 0
                                }, [s, R.createElement("span")]), l = R.createElement("li", {class: "nav-back"}, o),
                                c = function () {
                                    return J(y, n)
                                };
                            R.wrap(o, R.createElement("div", {class: "nav-item-wrapper"})), o.addEventListener("click", R.preventClick(c)), o.addEventListener("keydown", function (e) {
                        ...
                        if (0 === y && !1 !== Z.insertClose) {
                            var v = R.children(r, "ul"), u = R.createElement("a", {
                                    href: "#",
                                    role: "menuitem",
                                    tabindex: 0
                            ...
                            Z.labelClose && "" !== Z.labelClose || u.setAttribute("aria-label", (Z.ariaLabels || {}).close), R.wrap(u, R.createElement("div", {class: "nav-item-wrapper"})), u.addEventListener("click", R.preventClick(G)), u.addEventListener("keydown", function (e) {
                    ...
                    var t = 0 - (o - e.touches[0].clientX), n = "overlap" === Z.levelOpen ? F() * Z.levelSpacing : 0,
                        a = b + n;
                    ...
                    if (ae.removeEventListener("touchmove", q), ae.removeEventListener("touchend", e), N) {
                        var n = t.changedTouches[t.changedTouches.length - 1], a = 0 - (o - n.clientX),
                            r = "overlap" === Z.levelOpen ? F() * Z.levelSpacing : 0, i = b + r;
                        (a = "left" === Z.position ? Math.min(Math.max(a, 0), i) : Math.abs(Math.min(Math.max(a, -i), 0))) ? B(70 < a ? "open" : "close") : B("close", !1), O = o = null, N = !1
                    }
                }, H = function (e) {
                    var t = 0 - (o - e.touches[0].clientX), n = 0 - (O - e.touches[0].clientY);
                    if (!(Math.abs(t) < Math.abs(n))) {
                        var a = "overlap" === Z.levelOpen ? F() * Z.levelSpacing : 0, r = b + a;
                ...
                var U = function (e, t, n) {
                    ...
                    if (a) {
                        var r = a.value, i = a.parentNode, s = i.closest(".nav-wrapper");
            ...
            function Y(e, t) {
                if ((!X() || void 0 !== t) && (function () {
                    ...
                    }))[n.length - 1]); else if (!(n = ae.querySelector("#" + E + "-" + e + "-" + t))) return void console.warn("HC Offcanvas Nav: level " + e + " doesn't have index " + t);
                    if (n) {
                        var a = [];
                        if (e = Number(n.dataset.level), t = Number(n.dataset.index), 1 < e) {
                            ...
                            for (var i = 0; i < r.length; i++) {
                                var s = r[i], o = Number(s.dataset.level);
            ...
            function $(t, n, e) {
                void 0 === e && (e = !0);
                var a = ae.querySelector("#" + E + "-" + t + "-" + n), r = a.value, i = a.parentNode,
                    s = i.closest(".nav-wrapper"), o = R.children(i, ".nav-wrapper")[0];
            ...
            function J(t, e) {
                for (var n = t; n <= Object.keys(A).length; n++) if (n === t && void 0 !== e) U(t, e, !0); else if (0 !== t || Z.closeOpenLevels) for (var a = 0; a < A[n]; a++) U(n, a, n === t); else ;
    ...
    if (void 0 !== ne.jQuery) {
        var n = ne.jQuery, a = "hcOffcanvasNav";
        n.fn.extend({
    ...
    var e = n.hcOffcanvasNav, o = n.document, t = !1;
    try {
    ...
    var d = function (e, t, n) {
        ...
        c("transform");
        return function (e, t, n) {
            if (!1 === t || "" === t) e.style.transform = ""; else if ("x" === p(n)) {
                var a = "left" === n ? t : "-" + t;
    ...
    e.Helpers = {
        supportsPassive: t, hasScrollBar: function () {
            return o.documentElement.scrollHeight > o.documentElement.clientHeight
        }, isIos: r, isTouchDevice: i, isNumeric: s, formatSizeVal: l, toMs: function (e) {
        ...
        }, browserPrefix: c, children: v, wrap: function (e, t) {
        ...
        }, createElement: d, getElement: function (e) {
            var t = null;
        ...
        }, getAxis: p, setTransform: f, deprecated: h
    }
}(window);
!function () {
    "use strict";
